namespace EnergyTrading.Mapping
{
    ...
    public class NamespaceManager : INamespaceManager
    {
        ...
        {
            this.prefixDictionary = new Dictionary<string, string>();
            this.namespaceDictionary = new Dictionary<string, string>();

            // Memoize the namespace qualification function.
            Func<string, string> f = this.QualifyNs;
            this.qualifyNs = memoize ? f.Memoize() : f;
        ...
        public void RegisterNamespace(string prefix, string xmlNamespace)
        {
            ...
            lock (this.syncLock)
            {
                this.prefixDictionary[xmlNamespace] = prefix;
                this.namespaceDictionary[prefix] = xmlNamespace;
            }
        }
        ...
        public string LookupNamespace(string prefix, bool xname = false)
        {
            ...
            {
                return xname ? this.qualifyNs(value) : value;
            }
            return null;
        }
